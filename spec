...
local garbo = estilo {
	...
	menu1              = elemento { letra = branco, fundo = cinza0 },
	menu2              = elemento { letra = branco, fundo = cinza1 },
	menu2_invertido    = elemento { letra = branco, fundo = cinza1, atributos = { inverso } },
	selecao_do_menu    = elemento { letra = branco, fundo = cinza0, atributos = { inverso } },
